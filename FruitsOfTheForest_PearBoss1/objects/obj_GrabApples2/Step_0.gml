	...
	if (gamepad_button_check(0, gp_face2) && (global.player1Holding == true))
	{
		...
		if (blenderTimer >= 20)
		{
			with (obj_Blender)
				...
				obj_Blender.phy_position_x = (obj_GrabApplePlatfom3.phy_position_x + ((obj_GrabApplePlatfom4.x - obj_GrabApples2.phy_position_x)/3));
				obj_Blender.phy_position_y = (obj_GrabApplePlatfom3.phy_position_y - ((obj_GrabApplePlatfom4.y - obj_GrabApples2.phy_position_y)/3));
		...
		if (blenderTimer >= 10 && blenderTimer < 20)
		{
			with (obj_Blender)
				...
				obj_Blender.phy_position_x = (obj_GrabApplePlatfom3.phy_position_x + ((obj_GrabApplePlatfom4.x - obj_GrabApples2.phy_position_x)/2));
				obj_Blender.phy_position_y = (obj_GrabApplePlatfom3.phy_position_y - ((obj_GrabApplePlatfom3.y - obj_GrabApples2.phy_position_y)/2));
		...
		if (blenderTimer >= 0 && blenderTimer < 10)
		{
			with (obj_Blender)
				...
				obj_Blender.phy_position_x = (obj_GrabApples2.phy_position_x);
				obj_Blender.phy_position_y = (obj_GrabApples2.phy_position_y);
